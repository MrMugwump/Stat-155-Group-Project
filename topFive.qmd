...
# Model 4: 3-way interaction (PTS, AST, STL) plus TRB as additive term
model4 <- lm(salary ~ PTS * AST * STL + TRB, data = salariesAndTotals2021)

# Model 5: 3-way interaction (PTS TRB STL) plus AST as additive term
model4 <- lm(salary ~ PTS * TRB * STL + AST, data = salariesAndTotals2021)
